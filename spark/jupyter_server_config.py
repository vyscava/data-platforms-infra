...
#     "/root/jupyter-lsp/node_modules",
# ]

# def build_language_server_config():
#     config = {}

#     def add_lang(name, binary, argv_args, languages, version=2):
...
#     add_lang("pyright", "pyright-langserver", ["--stdio"], ["python"])
#     add_lang("sql", "sql-language-server", ["up", "--method", "stdio"], ["sql"])
#     add_lang("yaml", "yaml-language-server", ["--stdio"], ["yaml"])
#     # add_lang("json", "vscode-json-language-server", ["--stdio"], ["json"])  # double-check this name
#     # add_lang("unified", "unified-language-server", ["--stdio"], ["markdown"])

#     return config

# c.LanguageServerManager.language_servers = build_language_server_config()
...
#  Default: ''
c.ServerApp.allow_origin = 'https://jupyter.local.vitorgarbim.me'
...
#  Choices: any of ['blake2s', 'md5-sha1', 'sm3', 'md5', 'sha224', 'sha384', 'sha1', 'ripemd160', 'sha3_224', 'sha3_256', 'sha512_224', 'sha256', 'shake_128', 'sha3_512', 'sha512', 'sha3_384', 'shake_256', 'sha512_256', 'blake2b']
#  Default: 'sha256'
...
#  Choices: any of ['md5', 'sha384', 'sha1', 'sha3_256', 'sha256', 'blake2s', 'sha3_512', 'sha512', 'sha3_384', 'sha224', 'blake2b', 'sha3_224']
#  Default: 'sha256'
